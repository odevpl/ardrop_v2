...
const Popup = ({
  ...
  const popupContent = isOpen ? (
    <div className={`popupOverlay ${modalProps.overlayClassName || ''}`} onClick={() => closeOnOverlayClick && closePopup()}>
      <div
      ...
      >
        ...
        {Component ? <Component key={componentKey} onClose={closePopup} {...componentProps} {...rest} /> : null}
        {children}
      </div>
    </div>
  ) : null
